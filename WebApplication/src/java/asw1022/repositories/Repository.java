 ...
 */
public class Repository<T extends BasicObject> implements IRepository<T> {
    ...
    public List<T> readAll() {
        ...
        try {
            ...
            Logger.getLogger(Repository.class.getName()).log(Level.SEVERE, "readAll failed", ex);
        }
    ...
    public void add(T item) {
        ...
        try {
            ...
            Logger.getLogger(Repository.class.getName()).log(Level.SEVERE, "add failed", ex);
        }
    }
